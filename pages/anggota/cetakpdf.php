...
class PDF extends FPDF
{
  ...
  function Header()
  {
      ...
      $this->Ln(10);
      // Title
      $this->Cell(0,5,'DATA ANGGOTA','0','1','C',false);
...
$pdf->Cell(40,6,'Devisi',1,0,'C');
// $pdf->Cell(45,6,'Tanggal Kegiatan',1,0,'C');
$pdf->Cell(45,6,'Email',1,0,'C');
$pdf->Cell(40,6,'No Handphone',1,0,'C');
$pdf->Ln(1);
$no = 0;
$tampil = mysqli_query($conek, "SELECT * FROM  anggota  ");
...
while($data = mysqli_fetch_array($tampil) ) {
	...
	$pdf->Cell(45,5,$data['email'],1,0,'L');
	$pdf->Cell(40,5,$data['no_hp'],1,0,'L');
