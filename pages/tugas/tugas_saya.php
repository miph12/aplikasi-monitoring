          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                $cek = mysqli_query($conek, "SELECT * FROM anggota, tugas, monitoring where anggota.id_anggota = monitoring.kode_anggota and tugas.id_tugas = monitoring.kode_tugas and anggota.email = '$email' ");
                $no=1;
                ...
                if ($data['status'] == 'Belum Selesai' ) {
                 ...
                 ?>
                       <tr>
                        ...
                        <td>
                          <a href="index.php?page=pages/tugas/edittugassaya&id=<?php echo $data['id_monitoring']; ?>" class="btn btn-info" >Ubah Status</a> 
                        </td>
