      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="index.php?page=pages/pembagian/pembagian">Pembagian Tugas</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <a class="btn btn-warning" target="blank" href="pages/pembagian/cetakpdf.php"> <i class="glyphicon glyphicon-print"> </i></a>
                ...
                while ($data = mysqli_fetch_array($cek)) {
                 ?>
                       <tr>
                        ...
                        <td>
                          <a href="index.php?page=pages/pembagian/editpembagian&id=<?php echo $data['id_monitoring']; ?>" class="btn btn-xs btn-info" ><i class="fa fa-pencil" ></i></a> 
                          <a href="index.php?page=pages/pembagian/pembagian&delete=<?php echo $data['id_monitoring']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
                     </tbody>
