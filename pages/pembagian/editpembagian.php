          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                include("koneksi.php");
                $id = $_GET['id'];
                $lihat = mysqli_query($conek, "SELECT * from anggota, monitoring where anggota.id_anggota = monitoring.kode_anggota and 
                  monitoring.id_monitoring = '$id' ");
                  ...
                  <div class="box-body" >
                    <div class="row">
                      <div class="form-group col-xs-6 ">
                        ...
                        <!-- <button class="btn btn-warning btn-xs" data-toggle="modal" data-target="#Modaladddaa" >Cari Data <i class="glyphicon glyphicon-search"> </i></button> -->
        ...
        <table id="exampe1" class="table table-bordered table-striped">
          ...
          while ($a1 = mysqli_fetch_array($ambil)) {
            ...
            <tr>
              ...
              <td><a href="index.php?page=pages/pembagian/editpembagian&id=<?=$_GET['id'];?>&id_tugas=<?php echo $a1['id_tugas']; ?>" class="btn btn-default "><i class="glyphicon glyphicon-ok"> Pilih</i></a></td>
...
<?php 
 if (isset($_POST['simpan'])){
  ...
  $id_tugas       = $_POST['id_tugas'];
    ...
    $simpan = mysqli_query($conek, "UPDATE  monitoring  set kode_tugas = '$id_tugas' where id_monitoring = '$id_monitoring' ");
