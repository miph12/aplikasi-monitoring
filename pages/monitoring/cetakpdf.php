...
class PDF extends FPDF
{
  ...
  function Header()
  {
      ...
      $this->Ln(10);
      // Title
      $this->Cell(0,5,'DATA PEMBAGIAN TUGAS','0','1','C',false);
...
$pdf->Cell(40,6,'Nama Devisi',1,0,'C');
$pdf->Cell(90,6,'Nama Tugas',1,0,'C');
$pdf->Ln(1);
$no = 0;
$tampil = mysqli_query($conek, "SELECT * FROM anggota, tugas, monitoring where anggota.id_anggota = monitoring.kode_anggota and tugas.id_tugas = monitoring.kode_tugas ");
...
while($data = mysqli_fetch_array($tampil) ) {
  ...
  $pdf->Cell(40,5,$data['nama_anggota'],1,0,'L');
  $pdf->Cell(40,5,$data['bagian'],1,0,'L');
	$pdf->Cell(90,5,$data['nama_tugas'],1,0,'L');
