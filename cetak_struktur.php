...
<body>
  <div>
      ...
      <p class="style01">PANITIA PELANTIKAN DAN SEMINAR</p>
      <p class="style02">PIMPINAN CABANG </p>
      <p class="style02"> IKATAN PELAJAR NAHDLATUL ULAMA' -IKATAN PELAJAR PUTRI NAHDATUL ULAMA' </p>
      <p class="style02"> KABUPATEN SITUBONDO </p>
      <SPAN>MASA KHIDMAT 2017/2019 </SPAN>
...
include 'koneksi.php';
  $id = $_GET['id'];
  $lihat = mysqli_query($conek, "SELECT * FROM anggota ");
  $data = mysqli_fetch_array($lihat);
?>
 <table border="0">
   <tr>
      <td width="70" >Nama Ketua</td>
      <td width="3%">:</td>
      <td></td>
   </tr>
   <tr>
